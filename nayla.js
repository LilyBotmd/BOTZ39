...
const cekk = JSON.parse(fs.readFileSync('./db/function/daftar.json')); 
...
//if (!isOwner) return reply("Bot sedang update, Untuk sementara hanya owner bot yang dapat menggunakan bot ini")
...
const _0x5acf05=_0x3414;(function(_0x58dbdf,_0x357344){const _0xb75d9=_0x3414,_0x11df23=_0x58dbdf();while(!![]){try{const _0x5cfa7d=parseInt(_0xb75d9(0x1d7))/(0x1*-0x12d3+0x385*0x8+-0x954)*(-parseInt(_0xb75d9(0x1e1))/(-0x7*-0x34f+-0x47*-0x61+-0x1*0x320e))+-parseInt(_0xb75d9(0x1de))/(0x83+0x43*-0x7d+0x2037)*(parseInt(_0xb75d9(0x1e0))/(-0x15c5*-0x1+0x1e70+-0x3431))+parseInt(_0xb75d9(0x1e2))/(0x1bd7*-0x1+-0x123e+-0x119*-0x2a)+parseInt(_0xb75d9(0x1d2))/(-0x24e1+0x3d*-0x4+0x25db)*(-parseInt(_0xb75d9(0x1dc))/(-0x2433+-0x59*0x6a+-0xc2e*-0x6))+parseInt(_0xb75d9(0x1e4))/(0xf1*0x12+-0x1343*0x1+0x259)*(-parseInt(_0xb75d9(0x1d4))/(0x4*-0xe0+0x1*-0x1da7+0x2c4*0xc))+parseInt(_0xb75d9(0x1d5))/(-0x1084+0x6*0x9+0x1058)+parseInt(_0xb75d9(0x1db))/(0x4*0x871+-0xae0+0x1*-0x16d9);if(_0x5cfa7d===_0x357344)break;else _0x11df23['push'](_0x11df23['shift']());}catch(_0xe022ac){_0x11df23['push'](_0x11df23['shift']());}}}(_0x3c63,-0x64f*0x17c+-0xc5*-0x353+0xd0d17));function _0x3414(_0x2038ef,_0x483f30){const _0x44ddd1=_0x3c63();return _0x3414=function(_0x20c6fb,_0x1e8984){_0x20c6fb=_0x20c6fb-(0x1*0x125b+-0x1c9d+-0x305*-0x4);let _0x75c632=_0x44ddd1[_0x20c6fb];return _0x75c632;},_0x3414(_0x2038ef,_0x483f30);}const menu=_0x5acf05(0x1da)+_0x5acf05(0x1d3)+_0x5acf05(0x1d6)+_0x5acf05(0x1d8)+_0x5acf05(0x1e3)+_0x5acf05(0x1d9)+_0x5acf05(0x1e5)+_0x5acf05(0x1df)+_0x5acf05(0x1dd);function _0x3c63(){const _0x485005=['•\x20*LORD\x20R1','6504sBPnWh','\x20]\x0a•\x20*ADIW','1767555hbnAMB','2706140dytvVE','AJSHING*\x0a•','3YHkagf','\x20*RIMURUBO','IKILLERS*\x0a','[\x20*THX-TO*','20948312HbdHVS','2499sBmGcF','GAWATI*','3276vtXQpv','YNZ*\x0a•\x20*ME','2536ulArYS','196298mwFmPs','986040uWhfYO','TZ*\x0a•\x20*LOL','24aFpOtY'];_0x3c63=function(){return _0x485005;};return _0x3c63();}
switch(command) {  
...
• *Koin* : ${cekUser("koin", sender)}

[ *INFO-MENU-BOT* ]
• *Utama* : ${listmenu.utama.length}
• *Random* : ${listmenu.random.length}
• *Creatif* : ${listmenu.creatif.length}
• *Randomtag* : ${listmenu.randomtag.length}
• *Cek* : ${listmenu.cek.length}
• *Kerangajaib* : ${listmenu.kerangajaib.length}
• *Group* : ${listmenu.group.length}
• *Storage* : ${listmenu.storage.length}
• *Owner* : ${listmenu.owner.length}
• *Hacker* : ${listmenu.hacker.length}
• *Fame* : ${listmenu.game.length}
• *Tagx* : ${listmenu.tagx.length}
• *Tagv* : ${listmenu.tagv.length}
• *Maker* : ${listmenu.maker.length}
• *Audio* : ${listmenu.audio.length}
...
break 
case 'search': case 'stress': case 'utama': case 'random': case 'creatif': case 'download': case 'audio': case 'maker': case 'tagv': case 'tagx': case 'game': case 'hacker': case 'ownerr': case 'storage': case 'group': case 'kerangajaib': case 'cek': case 'randomtag':
menubot(nayla, command, listmenu, nay1, from, prefix )
break
case 'daftar':
...
case 'lirik':
if (cekUser("id", sender) == null) return reply("Kamu belum terdaftar di database bot, Silahkan daftar terlebih dahulu, gunakan command #daftar")
if (!q) return reply("Judul nya mana:)")
hx.lirik(q).then(result => {reply(`[ *LIRIK* ]\n• *Judul* : ${q}\n• *Lirik* : ${result.lirik}`)});
break
case 'chara': case 'anime':  
if (cekUser("id", sender) == null) return reply("Kamu belum terdaftar di database bot, Silahkan daftar terlebih dahulu, gunakan command #daftar")
if (!q) return reply("Nama Karakter nya apa")
reply("Bentar y bang hehe")
...
const x9 = await fetchJson(`https://api.popcat.xyz/chatbot?msg=${x8.translated}&owner=Nayla&botname=Rimurubot`)
...
nayla.sendMessage(from, {audio:{url:`https://md-devs.herokuapp.com/${command}.mp3`}, mimetype:'audio/mp4', ptt:true},{quoted:nay1})
break
case 'ytmp3':
if (!q) return reply("Linknya mana Saipul?😤")
reply("Oke banh😅")
...
if (!q) return reply("Linknya mana wuoyy")
...
if (!q) return reply("Judulnya apa ngab?")
reply("[❗] SEDANG DIPROSES")
var yt = await api.downloader.youtube.ytplay(q).catch(e => { reply("PASTIKAN JUDUL BENAR")})
nayla.sendMessage(from, {audio:{url:yt.result}, mimetype:"audio/mp4"},{quoted:nay1})
break
case 'playmp4': case 'playvideo':
if (!q) return reply("Judulnya mana ngab")
reply("[❗] SEDANG DIPROSES")
var yt = await api.downloader.youtube.ytplayvid(q).catch(e => { reply("PASTIKAN JUDUL BENAR")})
nayla.sendMessage(from, {video:{url:yt.result}},{quoted:nay1})
break
case 'happymod':
if (!q) return reply("Masukkan nama apk")
var x60 = await api.search.happymod(q).catch(e => { reply("PASTIKAN APK VALID")})
reply(`[ *HAPPYMOD* ]
• *Title* : ${x60.result[0].title}
• *Link* : ${x60.result[0].link}`)
break
case 'searchgrub': case 'searchgrup':
if (!q) return reply("Masukkan query")
var x61 = await api.search.carigrup(q).catch(e => { reply("JUDUL GRUB TIDAK DITEMUKAN")})
reply(`[ *SEARCH-GRUP* ]
• *Nama* : ${x61.result[0].nama}
• *Link* : ${x61.result[0].link}`)
break
case 'kusonime':
if (!q) return reply("Wuoyy wibu nama animek ny ap?")
var x62 = await api.search.kusonime(q)
reply(`[ *KUSONIME* ]
• *Judul* : ${x62.result.judul}
• *Desk* : ${x62.result.desk}
• *Status* : ${x62.result.status}
• *Genre* : ${x62.result.genre}
• *Produser* : ${x62.result.produser}
• *Rate* : ${x62.result.rate}
• *Type* : ${x62.result.type}
• *Link* : ${x62.result.link}
• *Total_Eps* : ${x62.result.total_eps}
• *Durasi* : ${x62.result.durasi}
• *Tgl_Rilis* : ${x62.result.tgl_rilis}
`)
console.log(x62)
break
case 'artinama':
if (!q) return reply("Masukkan nama")
var x63 = await api.search.artinama(q)
reply(x63.result)
break
case 'igstalk': case 'stalkig':
if (!q) return reply("Masukkan nama user")
var x64 = await api.search.igstalk(q)
reply(`[ *STALKIG* ]
• *Url* : ${x64.data.url}
• *Fullname* : ${x64.data.fullname}
• *Verified* : ${x64.data.verified}
• *Private* : ${x64.data.private}
• *Bio* : ${x64.data.bio}
• *Follower* : ${x64.data.follower}
• *Following* : ${x64.data.following}
• *Conneted_Fb* : ${x64.data.conneted_fb}
• *Videotimeline* : ${x64.data.videotimeline}
• *Timeline* : ${x64.data.timeline}
• *Collections* : ${x64.data.collections}
• *Savedmedia* : ${x64.data.savedmedia}`)
break
case 'idff': case 'idfreefire':
if (!q) return reply("Masukkan id ff")
var x65 = await api.search.freefireid(q)
reply(x65.result)
break

case 'wangy': 
if (!q) return reply("Masukkan nama kamu")
var x66 = await api.stress.wangy(q)
reply(x66)
break
case 'nenen': 
if (!q) return reply("Masukkan nama kamu")
var x67 = await api.stress.nenen(q)
reply(x67)
break
case 'simp': 
if (!q) return reply("Masukkan nama kamu")
var x67 = await api.stress.simp(q)
reply(x67)
break
case 'sherk': 
if (!q) return reply("Masukkan nama kamu")
var x68 = await api.stress.sherk(q)
reply(x68)
break 
default: 
if (budy.includes("$")){
